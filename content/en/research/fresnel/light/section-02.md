...
The reason of this is, that the molecules of the liquid, attracted by the surface of the tube, also in their turn attract other molecules of the liquid situated within their sphere of action, and so on, step by step. 

But in the emission-theory an analogous explanation is not admissible. This is because the fundamental hypothesis is that the luminous particles never exert any sensible effect on the path of neighboring particles. 
...
But when a portion of the wave-front is intercepted or retarded in its path by interposing an opaque or transparent screen, this transverse equilibrium is destroyed. Various points of the wave may now send out rays along new directions.

It would be exceedingly difficult to follow, by analytical mechanics, all the changes which a wave-front undergoes when a part of it is intercepted by a screen. We do not propose to derive the laws of diffraction in this way. We do not propose to inquire what happens in the immediate neighborhood of the opaque body, where:
...
We propose rather to compute the relative intensities at different points of the wave-front **only after it has gone a large number of wavelengths beyond the screen**. 
...
34. We shall not take up the problem of vibrations in an elastic fluid from the point of view which the mathematicians have ordinarily employed that is, considering only a single disturbance. 
