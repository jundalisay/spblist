...
Here we will explain how to accomplish this. This will provide yet another perspective on the Wilson loop. What follows also o↵ers an opportunity to explain a basic
aspect of quantum mechanics which is often overlooked when we first meet the subject.

The question is the following: what classical system gives rise to a finite dimensional quantum Hilbert space? 
...
is the phase space of the system rather than the configuration space. 
...
As such, it is analogous to Gauss’ law when quantising Maxwell theory and we should impose it as a constraint that defines the physical Hilbert space. There is an ordering ambiguity in defining this
