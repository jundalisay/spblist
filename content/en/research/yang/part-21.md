...
– 76 –We see that, even classically, Yang-Mills theory provides a somewhat richer structure
...
gap. This means that, at distances
1/⇤QCD , the force will be due to the exchange
...
we must have ⇠ ⇤2QCD since there is no other scale in the game.
...
There are also now 2 fermionic excitations which carry charge ± 12 . The spectrum now looks very different
from the confining phase.

Clearly in this case the Higgs and confining phases are different. Yet, because we have fermions in the fundamental representation, we will still have dynamical breaking of the flux tube and so fundamental Wilson loop W [C] does not provide an order
