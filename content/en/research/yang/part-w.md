...
Something special happens when we set = 0 in (2.86). Here the scalar potential vanishes which means that, at least classically, we can pick any expectation value v
...
– 112 –When the potential vanishes, it is possible to use the Bogomolnyi trick to rewrite
the energy functional. In terms of the non-Abelian magnetic field Bi = 12 ✏ijk Fjk , the
