...
Therefore, it will not be carried contrary to the motion of vortex AEIO towards the parts between I and S but only towards those between A and S. It should eventually reach a point where the line described by its motion tangentially touches one of those circles according to which the celestial matter rotates around center S. 
...
For example, if it initially moves along line NC, once it reaches C, where this curved line NC touches the circle described there by the globules of the second element around center S, it cannot help but immediately recede from S along the curved line C2, situated between this circle and the straight line tangent to it at point C. 
...
When it reaches 2 and exits the boundaries of the vortex it is in, it still retains the matter flowing around it for a while and is not entirely freed from it until it penetrates sufficiently into another vortex AEV, specifically until it reaches 3. 

In the same way, it carries the matter of this second vortex with it towards 4 into the boundaries of the third, and from this third towards 8 into the boundaries of the fourth, and so on, always doing the same whenever it migrates from one vortex to another. 

The line it describes with its motion is variously curved depending on the different motions of the vortices' matter it passes through. 

Thus, its part 234 is curved differently than the preceding NC2, because the matter of vortex F rotates from A through E towards V, and the matter of vortex S from A through E towards I. However, part 5678 of this line is almost straight because the matter of the vortex it is in is assumed to rotate around axis XX. Stars migrating from one vortex to another in this manner are comets, and 

<!-- I will try to explain all their phenomena here. -->


### 128. Phenomena of Comets
...
Soon after, it grew to a remarkable size and moved so swiftly through the northern pole that it described a portion of a great circle, thirty or forty degrees, in one day. Finally, it gradually disappeared near the stars of the Northern Fish or in the sign of Aries.
