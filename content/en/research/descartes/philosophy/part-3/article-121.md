...
weight: 56
description: "What We Mean by the Solidity and Agitation of Bodies"
writer:
  name: Rene Descartes
...
The air-aether of Vortex `AEIO` has a force which moves it circularly around the center `S`. It should be estimated by the size of the surface area it encounters. The larger this surface area, the more air-aether acts on it.
...
Gold can be stretched into filaments or sheets, or hollowed out like a sponge with many tiny holes, or other ways where it acquires more surface area relative to its matter and mass than the wooden globule. This is why a small globule of gold may not have as much force to retain the motion impressed on it as a much larger stone or wooden globule. 
...
It can also easily happen that `Star N` has much more force to continue in its straight-line motion than the surrounding air-aether globules. This can happen even if it contains less of the earth-aether's matter than the air-aether, in as many of these globules as are needed to occupy an equal space. 
