...
We have only one natural phenomenon from which an experiment of this matter can be drawn: namely, when a comet travels such a part of the sky that, first seen in the ecliptic, it is later seen near one of the poles, and then again in the ecliptic. 

Then, considering its distance, it can be estimated whether its light (which I will show below to be from the Sun) appears greater towards the ecliptic than towards the pole, all else being equal. AT VIII-1, 137
