...
### 131. Whether Fixed Stars Appear in Their True Places and What the Firmament Is

Here, it is worth noting that the rays coming from Y to the Earth incidentally hit the lines AE and VX, which represent the surfaces where these vortices terminate, and are thus refracted. 

Consequently, the fixed stars do not appear from Earth as if they are in the locations where they actually exist, but rather as if they are in the locations on the surface of vortex AEIO through which their rays, reaching the Earth or the vicinity of the Sun, pass. 

Moreover, it is possible that the same star may appear in two or more such locations. Since these locations have not been observed to change since astronomers first noted them, I believe that these surfaces are what is meant by the term Firmament.


### 132. Why Comets Are Not Visible to Us When Outside Our Sky, and Incidentally, Why Charcoal Is Black and Ashes Are White

The light of comets, being much weaker than that of fixed stars, does not have enough strength to move our eyes unless they are seen at a sufficiently large angle. 

Therefore, due to their distance, they are not visible when they are too far from our sky, as it is known that the more distant a body is, the smaller the angle under which it is seen. 

However, when they approach closer, there can be various reasons why they are not visible before entering our sky, and it is not easy to determine which reason is the primary one. For example, if the observer's eye is towards F, they will not yet see the comet at 2, because it will still be surrounded by the matter of the vortex it is leaving; but they will see it at 4, where it is farther away.

The reasons are:

1. The rays from the star F directed towards 2 are refracted on the convex surface of the matter of vortex AEIO, which still envelops the comet, and this refraction diverts them from the perpendicular, as I explained in Dioptrics.

These rays find it much harder to pass through the matter of vortex AEIO than through that of vortex AEVX, resulting in far fewer rays reaching the comet than if this refraction did not occur. These fewer rays, reflected to the eye, may be too weak to affect it.

2. The same side of the Moon always faces the Earth, so too does the same part of each comet always face the center of the vortex in which it is located, and only this part is suitable for reflecting rays. Thus, when the comet is at 2, the part that can reflect rays is facing the center S, and therefore cannot be seen by those near F. But as it moves from 2 to 3, it soon turns towards F, and thus begins to be visible there.

While the comet moves from N through C towards 2, the part of it facing the star S is more agitated and rarefied by the action of this star than the part facing away from it. Second, this agitation causes the finer and softer particles of the third element on its surface to separate from it, making it more suitable for reflecting rays than the surface of the other part. 

This can be understood from the explanation given about fire below, which shows that the reason extinguished charcoal appears black is that its entire surface, both internal and external, is covered with these softer particles of the third element. 

When these softer particles are separated by the force of fire, the charcoal, which was black, turns into ashes composed only of hard and solid particles, and therefore white. No bodies are more suitable for reflecting rays than white ones, and none less so than black ones.

3. The rarer part of the comet, being less suitable for motion, should always be on the concave side of the curved line described by the comet's motion, according to the laws of mechanics.

This concave side always faces the center of the vortex in which the comet is located (as here the concave part of NC2 faces center S, and the concave part of 234 faces F, etc.), causing the comet to turn when passing from one vortex to another, just as we see the feathered part of arrows flying through the air always lower when ascending and higher when descending.
...
Why comae do not also appear around fixed stars, and around the higher planets Jupiter and Saturn. 

But the answer is easy, first because they are not usually seen in Comets, since their apparent diameter is not greater than that of fixed stars, because then these secondary rays do not have enough strength to move the eyes.
...
But as for Jupiter and Saturn, I doubt not that, where the air is very clear, sometimes even short comae, extending towards the part away from the Sun may be seen around them.

I have read something like this somewhere, though I don't recall the author.
