...
Body C was distinct from body B solely because its parts, pressed downward by celestial globules, adhered to each other, we understand that another body, such as D, must subsequently be generated between these two.
...
Similar to how we observe in marshy places, when treading on the ground, water is pressed out, which then covers the surface.
