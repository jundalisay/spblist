...
Firstly, it is worth noting that the powder of filings does not accumulate randomly but rather forms small mounds, with some of them appearing like tiny tubes. 
...
This occurs because the ascending striated particles from the lower magnet exert force on each individual particle of the filings, which cannot enter unless they adhere to the same surfaces to which the upper magnet adheres, causing them to separate from the upper magnet. 
...
Similarly, as we mentioned before, only a few particles manage to reach us from the central region of the Earth because the majority of them, which pass through the inner crust of the upper region of the Earth, reverse their direction from one pole to another. As a result, only a weak magnetic force from the entire Earth is felt here with us.
...
Finally, the magnetic force is greatly diminished by moisture, rust, and exposure, and it is completely destroyed by intense heat. Rust, which forms from iron particles, clogs the channels' openings, while moisture and exposure to the air facilitate the formation of rust. Intense heat, on the other hand, completely disrupts the positioning of these particles. 
