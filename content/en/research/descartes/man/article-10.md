...
Consequently, I could perhaps demonstrate how another machine identical to this one could be formed from the fluid that gathers around `E`. However, I do not wish to digress further.
...
However, since this marrow does not cause movement of the limbs, it is sufficient for me here to mention that this marrow does not fill the tubes in such a way as to leave no room for the animal spirits, allowing them enough space to flow easily from the brain into the muscles to which these tubes, which should be considered as nerves, extend.
...
It is also important to note that, besides the tube B F, there is another tube, E F, through which the animal spirits are conveyed into muscle D and another tube, D G, through which they can exit. 

Similarly, muscle E, whose function is to move the eye in the opposite direction, receives animal spirits from the brain through tube C G and from muscle D through G, and they are returned to muscle D through E F.

Moreover, even though there appears to be no clear passage for the spirits contained in the two muscles D and E to exit, except for where they flow back and forth between each other, the particles of these spirits become more and more refined due to their agitation, allowing them to continuously seep through the membranes and parenchyma of the muscles. 

However, other spirits flow down through the two tubes B F and C G to replace the lost spirits.

Finally, there is a certain membrane H F I separating the two tubes B F and E F, which has 2 folds or valves H and I arranged in such a way that when the animal spirits try to descend from B towards H with greater force than those trying to ascend from E towards I, they depress and open this valve or membrane, allowing the spirits contained in muscle E to quickly flow into muscle D. 

But when the spirits trying to ascend from E towards I are stronger, or even if they are equally strong as the others, they lift and close the membrane or valve H F I, thus preventing the spirits from exiting muscle E. 

If neither side has enough force to pass through the membrane, it naturally remains open, and if the spirits contained in muscle D try to exit through D F E or D F B, the H valve can expand and block their path. Similarly, there is a valve similar to the previous one found between the two tubes C G and D G, which can be closed by the spirits coming from tube D G and opened by those flowing from C G.

With these explanations, it is easy to understand that if the animal spirits existing in the brain do not tend to flow or almost do not try to flow through the tubes B F and C G, the two valves F and G remain partially open or gaping, and the two muscles D and E remain flaccid and inactive, as the animal spirits contained in them flow freely from one to the other, starting from E through F to D and reciprocally from D through G to E. 
...
If the spirits leaving the brain flow with greater force through B F than through C G, they close the membrane or valve G and open F; and depending on whether the valve is more or less open, the muscle D, from which the spirits cannot exit, contracts, while E stretches, causing the eye to turn towards D. 
...
Although these spirits are very mobile and subtle, this does not prevent them from having the power to inflate, stretch, and thus harden the muscles in which they are contained. Just as air contained in a leather bellows makes it more swollen and harder, and tends to stretch the hides it contains.

Whatever has been explained so far about nerve A and the two muscles D and E applies to all other nerves and muscles. 

This machine moves so diversely, like our bodies, due solely to the force of the animal spirits flowing from the brain into the nerves. 

For each movement and its opposite determination, two such tubes play a role, like B F D and C G E, and two others like D G and E F, as well as the two valves such as H F I in Figure VIII.

As for the methods by which these tubes are inserted into the muscles, even though they may vary a thousand times, it will not be difficult to indicate what their differences are if one understands the shape and use of each muscle, as can be learned from anatomy.

For instance, the eyelids are moved by muscles. One of which, namely T in Figure IX, serves solely to open the upper one, while the other, namely V, serves to alternately open and close both.
