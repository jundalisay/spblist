...
<!-- , and is not other than I above supposed it.  -->
...
<!-- , and still more clearly when we see its resemblance in  -->
...
<!-- Even though no more rays enter from the various points of the object `VXY`, taken all together, into the fundus of eye `A` than into that of eye `B`,  -->
