...
- what things are still needed to be discovered
 ...
 <!-- things must be thought out in all disciplines.  -->
...
<!-- But now, however candid and open-minded all may be, and not one ever thrust any doubt on us as true, but exhibit all things in good faith, nevertheless,  -->

For every opinion, there is a contrary opinion. This makes the people unsure on whom to believe in. 

<!-- since hardly anything has ever been said by one on which the contrary has not been asserted by someone else, we would always be uncertain as to whom to believe.  -->

It would be useless to vote for who is correct because the truth is often found by a few people. 

<!-- It would be of no avail to count votes so that we might follow the opinion which has more authors; for, if it is a difficult question, it is more credible that its truth could have been found by a few than by many. But even if all should agree among themselves, their teaching would not be sufficient;  -->
...
<!-- , for example, though we should retain the demonstrations of all others in memory, unless we are also fitted by nature for the resolving of whatever problems may be set; nor shall  -->
...
<!-- There is no better reason why nothing is now found in vulgar philosophy so evident and certain that it cannot be called into question  without distinction-->

They then place their full faith these conjectures, confusing them with true and evident things.*
<!-- at length could conclude nothing which did not seem to depend on some such proposition, and so that which was not uncertain. -->

{{< n n="A clear example is the sophistry of Relativity by Einstein which is very complicated and is just pure conjecture." >}}


<!-- But lest we slip into the same error in the future, here are reviewed all -->
...
<!-- The understandings from our intuition leaves us no doubt. 

The concept of a pure and attentive mind:
- does not doubt
- is born from the light of reason alone
- is more certain by its own deduction, because simpler, although we have already noted that it cannot be done ill by man. ' -->
...
- a globe has only 1 surface
 ...
 <!-- and similar things, which are much more than most people observe, because they refuse to turn their minds to so easy things. -->
...
<!--  latest times in the schools, 
because it would be very difficult to use the same names, and to have a totally different meaning;  -->

I transfer what I mean to that Latin word "intuition" because I have no words for it myself. 

<!-- but I only note what the individual words mean in Latin, so that, when my own are lacking, I can transfer those that seem most suitable to me. -->
...
<!-- only must 2 and 2 be perceived to make 4, and also 3 and 1 make 4, but, moreover,  -->
