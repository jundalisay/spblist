...
## Proposition 33; Body B, under the conditions stated previously, can be moved in any direction by any additional force, however small.

Proof: Because all bodies immediately contiguous to B are in motion (by hypothesis), and B (Prop. 32) remains unmoved, as soon as they touch B they will be reflected in another direction while retaining their original motion (Prop. 28 Part 2). 

Thus body B is all the time automatically being lefl by immediately contiguous bodies. 
...
Let us then conceive B as four times as large as the external body by whose force it is impelled. 
...
Scholium: This is the case with fluid bodies. It follows that fluid bodies are those that are divided into many tiny particles moving with equal force in all directions.
