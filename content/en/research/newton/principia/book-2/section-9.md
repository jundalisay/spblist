...
If a solid sphere, in an uniform and infinite fluid, revolves about an axis given in position with an uniform motion, and the fluid is forced around by only this impulse of the sphere ; and every part of the fluid perse
