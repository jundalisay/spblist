...
The rise and fall of prices in an economy therefore reflect the changing desires of the people, manifesting as their demand. 

This is more obvious in democratic countries where prices can rise and fall dramatically. 

[Economic Superphysics aka Supereconomics](/social/economics/) is the branch of Social Superphysics that deals with the changing waves of demand in order to match that demand with supply as quickly as possible. 


<!-- The desire for anything changes. 
- Today you might want ice cream. 
- Tomorrow you might want hot coffee. 

This constantly-changing desire makes you change your "demand" for goods and serices. 


## Dynamic Ocean Waves, Static Ice Particles

The constant changing of desire is similar to the constant changing of a wave. An ocean will lose its waves if it is turned to ice. 

If you chip away a piece of ice from the ocean, then you have a piece of it, like a particle of the ocean. This particle is like a snapshot of the ocean, something that cannot be done so easily when it is a dynamic wave. Examples of such a snapshot are the ice core samples from Antarctica. 

{{< img src="/graphics/econ/icecore.jpg" alt="Ice Core Sample" cap="Ice cores show the changing patterns in the heat or cold of the climate" >}}

These allow scientists to assign year-numbers, CO2 levels, and temperatures based on the patterns.  


## Dynamic Beauty-Opinion, Static Beauty Points

Likewise, judges desire different features in beauty contestants. They then give more points to the contestant that has the most features that they desire. 

{{< img src="/photos/social/pageant.jpg" alt="Beauty Contest" cap="There is no single standard for beauty just as there is no single event in an ice core." >}}

The winner of the beauty contest is arrived at by averaging the total points. This guarantees that she is desired to some extent by all the judges. 

In an international beauty contest, no single country repeatedly wins over ad over.   


## Desire is the Root of Demand

In an economy, prices are the objective indicator of what is desired by society, manifesting as demand.  In fact, the concepts of GDP, Inflation, and Wealth all extend from prices.
 -->
<!-- This particle has still the same staticity as the ocean.

This is different from taking a cup of water from an ocean wave. That cup does not keep on  something that   

 which manifest objectively as prices-particles. This is similar to how a subjective beauty contest is decided by objective beauty-points from judges.  -->



<!-- The fulfillment of demand is done by actually delivery of goods and services. This has been done in various ways throughout history:

- By a king forcing his slaves to produce and deliver goods and services. 
- By people producing and bartering goods and services with each other. 
- By people giving and getting money by buying and selling goods and services.  -->

<!--  from the Through an agreement-based points system. Since this micro-granular points-based system is based on waves, it can scale easily to the macro and national level. 

To undertand how, we have to explain how particles scale into waves. -->


<!-- ## Ideas are Particles, Feelings are Waves

Price-particles are ideas, whereas desires are feeling-waves. 

Since particles are static, then it follows that ideas are static. When you get an idea, it is really your mind moving towards that static idea through the action of thinking. 

The thinking action comes from a desire to think. This means that feeling-waves are dynamic and that the entire universe gets its motion from the feelings of Its Creator.
...
Ideas can be lost easily, but feelings take time to disappear. This is because an idea is an external particle (comes from outside) which can 'escape' the mind.

Feelings, on the other hand, are an internal wave which emerge whenever the mind is struck and vibrated. The mind can convert a feeling into an idea just as physicality (such as the photoelectric effect) can convert light waves into light particles. 

Even if a feeling is converted into an idea, its true nature still is that of a feeling. For example, feelings cannot be traded, but they can be spread via sympathy, just like sound. You can never 'dispose' of your love by giving it to another person. Instead, you can only make that person feel some of it through actions, and even then, it will not be exactly in the same degree as yours.
...
What we see as a gold coin gives our senses a small impression, which we then convert as an idea-'particle' of a gold coin. 

If we were omniscient, then we would not only perceive the gold coin as a coin, but also as bullion being minted, as gold ore being turned into bullion, as star dust being turned into gold ore, and as start dust being formed from the Big Bang  -- all at the same time. 

In short, we would know everything about that gold coin as a wave from its absolute past to its absolute future*.
...
However, our interest here is socio-economics, specifically, how waves of desires cause recessions, price fluctuations etc., so that we can build more stable socio-economic systems.  -->

The collective wave of desire of society is most easily seen in the following which can be be bought by the public:
- stock prices
...
Metaphysically, these ideas convert an economy from being a static system for creating treasure-particles for the ego [the feeling of the self], into a dynamic one where there is a constant creation and flow of value-waves in a society-organism [collection of selves]. 
