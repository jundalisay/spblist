...
Buying and selling are rooted in waves of desires, which manifest objectively as prices-particles. This is similar to how a subjective beauty contest is decided by objective beauty-points from judges. 

![beauty contest](/photos/social/pageant.jpg)

The ideas of GDP, Inflation, and Wealth then all extend from prices. 

[Superphysics](/social/economics/) is the branch of Social Superphysics that deals with the changing waves of demand in order to match that demand with supply as quickly as possible. 

The fulfillment of demand is done by actually delivery of goods and services through an agreement-based points system. Since this micro-granular points-based system is based on waves, it can scale easily to the macro and national level. 
...
Our prediction for the coming economic crisis in 2019 as a global stagflation* is based on the metaphysical supposition that economic activity is ultimately based on demand, which is then based on desire as feeling-waves. 

> *Update Jan 2022: This happened 1 year later than predicted as the Covid stagflation


Since an economy has the desires of many people, then we call the gross economic demand as **the collective wave of human desire**.
