...
We should find a sweet spot via maximization wherein we can cut the supply of water to give us higher revenues, but not too much that it would kill our market (by dying from thirst, for example).
...
To Adam Smith and Supereconomics, **use-value should not be compared to exchangeable value just as apples should not be compared to oranges**. This is because use-value is personal while exchangeable value is social. 
