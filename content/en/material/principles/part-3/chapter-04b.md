---
heading: "Chapter 4b"
title: "Electromagnetism: Virtual Photon Vortices"
...
Straight channels are needed for magnetism so that virtual photons can be funneled and pass through in straight lines. 
- Their concentration creates a magnetic force.
- The entrance and exit of the channels creates a funnel on both sides. 

These fields and forces can be done with or without matter. 

These chanels can also be formed via vortices of virtual photons. These will draw them into a dipole, as an entrance and exit of the vortex.  


current is charge amount (quantity)
voltage is energy per chage (quality)
...
### Electromagnetism is not caused by Special Relativity 
...
{{< i s="/graphics/physics/em.jpg" a="Cartesian electromagnetism" >}}
