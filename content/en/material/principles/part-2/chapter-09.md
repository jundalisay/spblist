...
The proper and natural way to judge the space of a cloud on Trafalgar square is to know the nature of both:
- the cloud, and
- Trafalgar square.
...
In this way, the person in `A1` who hears a thunder in `B2` will know its location by extracting the relation of the cloud and the area from his memory. This relation is aethereal relationality, which becomes gravitational relationality when applied to the spatial layer. 
