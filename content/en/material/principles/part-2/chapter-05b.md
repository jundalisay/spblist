...
--- | --- | --- | ---
Spatial | Spacetime Qosts or Empty Space | {{< i s="/graphics/physics/general.jpg" a="Spacetime" >}} | Empty space is made up of invisible spacetime particles that fill up the universe. These have very little or no rotation and is why they have seemingly no effect on anything. Rather, they go with the powerful qosts mentioned below as to create the forces of gravity, dark matter, dark energy, and atom cohesion. 
...
Material | Material Qosts or Atomic Spaces | {{< i s="/graphics/physics/hyperfine.jpg" a="Atomic Space" >}} | The nucleus of an atom creates an atomic space for its electrons. 
...
<!-- Other Rules fo Forms of Gravity in Other Universes lead to Different Spacetime 'structures'

{{< i s="https://sorasystem.sirv.com/photos/darkmatter.jpg" a="Dark Matter" >}} -->


In this universe, the aether decided that galactic qosts must manifest as 1-dimensional points. 

In other universes within the multiverse however, the aether might decide for gravitation to manifest as 4-D blobs, 3-D planes, or 2-D lines. These then would create different spacetimes. 

However, the "Superphysics" would be the same.
