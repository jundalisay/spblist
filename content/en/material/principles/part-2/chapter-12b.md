...
[Comets](https://en.wikipedia.org/wiki/Comet) are small objects that traverse a stellar system, producing a 'tail' from 'outgassing'. 
...
<!-- Sure, general relativity (GR) predicts paths better. But it sees warping as the cause, whereas Cartesian Physics sees the warping as an effect of vortex strength and the curvature as an effect of vortex rotation. So GR is a dead end. That's why it is unable to explain other spacetime phenomena nor create any spacetime technology. -->
